...
f_dot_snap_dir()     { cd; snap-dir.sh $MY_SNAP/dotfiles $DOT_FILES_ALL $DOT_FILES_INIT; }
f_dot_snap_tar()     { cd; snap-tar.sh -t -D $MY_SNAP -o dotfiles $DOT_FILES_ALL $DOT_FILES_INIT; }
f_dot_snap_tar_n()   { cd; snap-tar.sh -t -D $MY_SNAP -o dotfiles $DOT_FILES_ALL $DOT_FILES_INIT -n; }
#======================================================
# main
#======================================================
