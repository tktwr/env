...
LS_COLORS="$LS_COLORS:*.html=34"
LS_COLORS="$LS_COLORS:*.md.html=34"
#LS_COLORS="$LS_COLORS:*.md=33"
...
LS_COLORS="$LS_COLORS:*.png=33:*.jpg=33:*.bmp=33"
LS_COLORS="$LS_COLORS:*.tif=33:*.hdr=33:*.exr=33"
